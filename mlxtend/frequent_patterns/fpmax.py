...
def fpmax(df, min_support=0.5, null_values=False, use_colnames=False, max_len=None, verbose=0):
    ...
    return fpc.generate_itemsets(generator, df, disabled, len(df), colname_map)
